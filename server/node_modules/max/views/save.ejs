...
<body>
<div id="head">
    <img src="images/wfok.gif" />
</div>
<div id="wfok">
    <ul>
        <li>
            <span class="l">订单号：</span>
            <span class="r"><%=wfno%></span>
        </li>
        <li>
            <span class="l">订购产品：</span>
            <span class="r"><%=wfproduct%></span>
        </li>
        <li>
        ...
        <li>
            <span class="l">订购总价：</span>
            <span class="r">398元</span>
        </li>
        <li>
            <span class="l">尺码：</span>
            <span class="r"><%=chima%></span>
        </li>
        <li>
        ...
        <li>
            ...
            <span class="r"><%=wfname%></span>
        </li>
        <li>
            <span class="l">手机号码：</span>
            <span class="r"><%=wfmob%></span>
        </li>
      	<li>
            <span class='l'>所在地区：</span>
            <span class='r'><%=wfprovince%><%=wfcity%><%=wfarea%><%=wfaddress%></span>
        </li>
        <li>
            <span class="l">付款方式：</span>
            <span class="r"><%=wfpay%></span>
        </li>
    </ul>
</div>
<div id="foot">
    <a href='javascript:history.go(-1);' title="返回首页"><img src="images/wfgo.gif" alt="返回首页" /></a>
</div>
